...
describe("Conjunto de testes app",()=>{
    ...
    it ("Testando clientes/listar Endpoint",async()=>{
        const databaseSpy = jest.spyOn(database, 'buscaTodosDados');
        databaseSpy.mockReturnValue("ClienteTeste");

        //cenário
        const esperado="ClienteTeste";
    ...
    it ("Testando /clientes/listar/:key Endpoint",async()=>{
